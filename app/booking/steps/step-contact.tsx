    ...
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        <div className="space-y-1.5">
          <Label htmlFor="contactName" className="text-sm font-medium">{copy.contactName}</Label>
          <Input
            id="contactName"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="contactEmail" className="text-sm font-medium">{copy.contactEmail}</Label>
          <Input
            id="contactEmail"
            type="email"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="contactPhone" className="text-sm font-medium">{copy.contactPhone}</Label>
          <Input
            id="contactPhone"
            type="tel"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="contactNotes" className="text-sm font-medium">
            {copy.contactNotes} <span className="text-muted-foreground font-normal">{copy.optional}</span>
          </Label>
          <Textarea
            id="contactNotes"
