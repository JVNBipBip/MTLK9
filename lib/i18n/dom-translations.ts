export const frenchTextTranslations: Record<string, string> = {
  "Training Programs": "Entraînement",
  ...
  "Montreal dog training": "Un dressage de chiens à Montréal",
  "Montreal dog training.": "Entraînement canin à Montréal.",
  "See If Your Dog Qualifies": "Vérifiez si votre chien est admissible",
  ...
  "Does your dog...": "Votre chien...",
  "You're not a bad owner. These are the most common reasons Montreal dog owners reach out to us.":
    "Vous n'êtes pas un mauvais propriétaire. Ce sont les raisons les plus courantes pour lesquelles les propriétaires de chiens à Montréal nous contactent.",
  "Swipe/Scroll to see each challenge": "Balayez ou faites défiler pour voir chaque défi",
  "Common Challenge": "Défi courant",
  "Pull on every walk?": "Tire à chaque promenade?",
  "You dread taking them out. Every walk is a battle.":
    "Vous redoutez les sorties. Chaque promenade devient un combat.",
  "Lunge or bark at other dogs?": "Se lance ou jappe après les autres chiens?",
  "You cross the street, avoid the park, walk at odd hours.":
    "Vous traversez la rue, évitez le parc et sortez à des heures inhabituelles.",
  "Destroy things when left alone?": "Détruit des objets lorsqu'il est seul?",
  "You can't leave the house without worrying.": "Vous ne pouvez pas quitter la maison sans vous inquiéter.",
  "Bite, nip, or jump on people?": "Mord, pince ou saute sur les gens?",
  "Guests are afraid. You're embarrassed and on edge.":
    "Les invités ont peur. Vous êtes gêné et constamment sur vos gardes.",
  "Find your training path": "Trouver votre parcours d'entraînement",
  "How It Works": "Comment ça fonctionne",
  "Real results start with a clear plan.": "Les vrais résultats commencent par un plan clair.",
  "Frequently Asked Questions": "Questions fréquentes",
  "Still have questions?": "Vous avez encore des questions?",
  "Ready to get started?": "Prêt à commencer?",
  "Start with a free call": "Commencez par un appel gratuit",
  ...
  "Training built around your dog.": "Un entraînement adapté à votre chien.",
  "Choose the path that fits your goals.": "Choisissez le parcours qui correspond à vos objectifs.",
  ...
  "Dog Breed": "Race du chien",
  "Dog Age": "Âge du chien",
  "Your Name": "Votre nom",
  ...
  "Recommended specialist": "Spécialiste recommandé",
  Staff: "Équipe",
  slot: "créneau",
  slots: "créneaux",
  "Times on": "Heures le",
  "In-person assessment": "Évaluation en personne",
  "In-person evaluation (60-75 minutes)": "Évaluation en personne (60 à 75 minutes)",
  "To be confirmed by email": "À confirmer par courriel",
  When: "Quand",
  Where: "Où",
  What: "Quoi",
  "You're in. Your assessment is booked.": "C'est confirmé. Votre évaluation est réservée.",
  ...
  "Questions before then?": "Des questions d'ici là?",
  "Specialist calendar is not configured. Please contact us by phone or email.":
    "Le calendrier du spécialiste n'est pas configuré. Veuillez nous contacter par téléphone ou par courriel.",
  "Failed to submit booking form.": "Impossible d'envoyer le formulaire de réservation.",
  "Could not submit right now. Please try again in a moment.":
    "Impossible d'envoyer pour le moment. Veuillez réessayer dans quelques instants.",
  "Could not load status.": "Impossible de charger le statut.",
  "Could not load profile.": "Impossible de charger le profil.",
  "Could not load training portal status.": "Impossible de charger le statut du portail d'entraînement.",
  "Could not load available times.": "Impossible de charger les disponibilités.",
  "Could not create booking.": "Impossible de créer la réservation.",
  "Could not save package.": "Impossible d'enregistrer le forfait.",
  "Could not save private package.": "Impossible d'enregistrer le forfait privé.",
  "Please read and accept the private training agreement before saving a package.":
    "Veuillez lire et accepter l'entente d'entraînement privé avant d'enregistrer un forfait.",
  "Please read and accept the private training agreement before updating your package.":
    "Veuillez lire et accepter l'entente d'entraînement privé avant de modifier votre forfait.",
  ...
  Tomorrow: "Demain",
  Trainer: "Entraîneur",
  "All trainers": "Tous les entraîneurs",
  ...
  "Request sent. Staff will review it and email you once it has been accepted or declined.":
    "Demande envoyée. L'équipe l'examinera et vous enverra un courriel lorsqu'elle sera acceptée ou refusée.",
  "Please enter the email you used for your assessment.": "Veuillez entrer le courriel utilisé pour votre évaluation.",
  "Could not verify your profile.": "Impossible de vérifier votre profil.",
  "Could not validate this booking link.": "Impossible de valider ce lien de réservation.",
  "Could not load available schedule slots.": "Impossible de charger les créneaux disponibles.",
  "Could not load booking access data.": "Impossible de charger les données de réservation.",
  "Booking summary": "Résumé de la réservation",
  "About Montreal Canine Training": "À propos d'Entraînement Canin Montréal",
  ...
  "Back to training portal": "Retour au portail d'entraînement",
  "Training Methods & Approach": "Méthodes et approche d'entraînement",
  "Services & Classes": "Services et cours",
  "Getting Started": "Pour commencer",
  "What type of training methods are used?": "Quels types de méthodes d'entraînement utilisez-vous?",
  "What is the main focus of your training?": "Quel est l'objectif principal de votre entraînement?",
  "What can we expect in private classes?": "À quoi peut-on s'attendre dans les cours privés?",
  "What type of services do you offer?": "Quels types de services offrez-vous?",
  "How can I enroll my dog in a group class?": "Comment inscrire mon chien à un cours de groupe?",
  "How can I reach out to a trainer and learn more about the services?":
    "Comment puis-je joindre un entraîneur et en savoir plus sur les services?",
  ...
  "Customized Training Programs": "Entraînement personnalisé",
  "Real Training, Real Results": "Entraînement concret, résultats réels",
  "A Team of Professionals": "Une équipe de professionnels",
  "Previous challenge": "Défi précédent",
  "Next challenge": "Défi suivant",
  "Go to slide": "Aller à la diapositive",
  "You're Not Alone": "Vous n'êtes pas seul",
  "The numbers tell the story": "Les chiffres parlent d'eux-mêmes",
  "Study source:": "Source de l'étude :",
  "Texas A&M, 43,517 dogs studied": "Texas A&M, 43 517 chiens étudiés",
  "of dogs exhibit behavioral issues": "des chiens présentent des problèmes de comportement",
  "show separation or attachment behaviors": "présentent des comportements de séparation ou d'attachement",
  "of owners ever enroll in formal training": "des propriétaires inscrivent leur chien à un entraînement formel",
  "You don't have a bad dog. You have a dog that needs a plan.":
    "Vous n'avez pas un mauvais chien. Vous avez un chien qui a besoin d'un plan.",
  "Real Results": "Résultats réels",
  "Transformation stories": "Histoires de transformation",
  "Every dog on this page started exactly where yours is now.":
    "Chaque chien sur cette page a commencé exactement là où le vôtre se trouve aujourd'hui.",
  Before: "Avant",
  After: "Après",
  "Before Training": "Avant l'entraînement",
  "After Training": "Après l'entraînement",
  "See All Results": "Voir tous les résultats",
  "Go to story": "Aller à l'histoire",
  "Transformation Story": "Histoire de transformation",
  "From stress to calm": "Du stress au calme",
  "Simple Process": "Processus simple",
  "How it works": "Comment ça fonctionne",
  "From your first call to a stable, trained and confident dog, here's how to start.":
    "De votre premier appel à un chien stable, entraîné et confiant, voici comment commencer.",
  "Evaluation Session": "Séance d'évaluation",
  "Your Custom Training Plan": "Votre plan d'entraînement personnalisé",
  "Training + Ongoing Support": "Entraînement et soutien continu",
  "Tell us what's going on. We'll figure out the right path together. 15 minutes, no commitment.":
    "Dites-nous ce qui se passe. Nous trouverons ensemble le bon parcours. 15 minutes, sans engagement.",
  "We meet you and your dog, assess their needs, create a custom training plan, and start hands-on training right away.":
    "Nous rencontrons votre chien, évaluons ses besoins, créons un plan personnalisé et commençons le travail pratique tout de suite.",
  "You get a clear roadmap: what we'll work on, how many sessions, what you'll practice between sessions, and what success looks like.":
    "Vous recevez une feuille de route claire : les objectifs, le nombre de séances, les exercices entre les séances et les critères de réussite.",
  "We train together in real environments. You get homework, video check-ins, and support between sessions. We're with you until it clicks.":
    "Nous travaillons ensemble dans de vrais environnements. Vous avez des devoirs, des suivis vidéo et du soutien entre les séances. Nous restons avec vous jusqu'à ce que ça fonctionne.",
  ...
  "Every dog is different. Every path starts with understanding yours.":
    "Chaque chien est différent. Chaque parcours commence par comprendre le vôtre.",
  "Start your dog's training journey with a 75-minute evaluation session designed to establish the right program for both you and your dog.":
    "Commencez le parcours d'entraînement de votre chien avec une séance d'évaluation de 75 minutes conçue pour établir le bon programme pour vous et votre chien.",
  "Our most popular option! Private classes offer personalized, hands-on training tailored to your specific goals. Only offered after a consultation.":
    "Notre option la plus populaire! Les cours privés offrent un entraînement personnalisé et pratique adapté à vos objectifs précis. Offerts uniquement après une consultation.",
  "A variety of structured group classes available for all dogs, ranging from basic foundations to advanced obedience training.":
    "Une variété de cours de groupe structurés pour tous les chiens, des bases fondamentales à l'obéissance avancée.",
  "Book a consultation and we'll walk through your dog's behaviour, your goals, and whether private lessons or a group series is the best fit.":
    "Réservez une consultation et nous passerons ensemble le comportement de votre chien, vos objectifs, et si des leçons privées ou une série en groupe convient le mieux.",
  "Dogs who lunge, bark, or shut down around triggers":
    "Chiens qui se lancent, jappent ou figent face aux déclencheurs",
  "Structured protocols covering the Three D's, attention cues, engagement, leash work, confidence building, and real-world scenario training":
    "Protocoles structurés couvrant les trois D, les signaux d'attention, l'engagement, le travail en laisse, la confiance et les scénarios réalistes",
  "Private & group classes": "Cours privés et cours de groupe",
  "Choose Reactivity Format": "Choisir le format réactivité",
  "Dogs who need focused, one-on-one attention": "Chiens qui ont besoin d'une attention individuelle ciblée",
  "Behaviour modification, leash reactivity, aggression, confidence building, separation anxiety, resource guarding, and handler skill development":
    "Modification du comportement, réactivité en laisse, agressivité, confiance, anxiété de séparation, protection des ressources et compétences du maître",
  "3, 5, or 7 session packages": "Forfaits de 3, 5 ou 7 séances",
  "Book Private Training": "Réserver un entraînement privé",
  "Dogs 9 months+ who need reliable real-world skills":
    "Chiens de 9 mois et plus qui ont besoin de compétences fiables dans la vraie vie",
  "Basic and advanced obedience, the Three D's, engagement, pack walks, high-distraction proofing, and off-leash reliability":
    "Obéissance de base et avancée, les trois D, engagement, marches en groupe, distractions fortes et fiabilité sans laisse",
  "Choose Obedience Format": "Choisir le format obéissance",
  "Private & group classes — Level 1 & Level 2": "Cours privés et de groupe — niveau 1 et niveau 2",
  "Puppies 10–20 weeks & teen dogs 5–9 months": "Chiots de 10 à 20 semaines et adolescents de 5 à 9 mois",
  "Socialisation, confidence building, bite inhibition, intro to obedience, marker training, and focus around distractions":
    "Socialisation, confiance, inhibition de la morsure, introduction à l'obéissance, marqueur et concentration autour des distractions",
  "Choose Puppy Class Format": "Choisir le format chiot",
  "Owners who want training in their own environment":
    "Propriétaires qui veulent un entraînement dans leur propre environnement",
  "Behaviour modification, door manners, separation anxiety, house training — all addressed where the problems actually happen":
    "Modification du comportement, bonnes manières à la porte, anxiété de séparation et propreté, travaillées là où les problèmes se produisent",
  "Consultation + 3, 5, or 7 session packages": "Consultation + forfaits de 3, 5 ou 7 séances",
  "Book In-Home Training": "Réserver un entraînement à domicile",
  ...
  "If you already know the format you want, choose it below. If not, book an assessment and we'll recommend the right path for your dog.":
    "Si vous savez déjà quel format vous voulez, choisissez-le ci-dessous. Sinon, réservez une évaluation et nous recommanderons le bon parcours pour votre chien.",
  ...
  "Start Program Sign-Up": "Commencer l'inscription au programme",
  "Private & Group Classes": "Cours privés et de groupe",
  "Private & Group Classes — Level 1 & Level 2": "Cours privés et de groupe — niveau 1 et niveau 2",
  "Private & Group Classes — Puppies & Teens": "Cours privés et de groupe — chiots et adolescents",
  "Most Popular Option — 3, 5, or 7 Session Packages": "Option la plus populaire — forfaits de 3, 5 ou 7 séances",
  "Reactivity Training in Montreal": "Entraînement pour la réactivité à Montréal",
  "Private Dog Training in Montreal": "Entraînement canin privé à Montréal",
  "One-on-one sessions designed to provide personalized, hands-on training tailored specifically to your dog's needs.":
    "Des séances individuelles conçues pour offrir un entraînement personnalisé et pratique, adapté précisément aux besoins de votre chien.",
  "Obedience Training in Montreal": "Entraînement d'obéissance à Montréal",
  "Puppy Training in Montreal": "Entraînement des chiots à Montréal",
  "In-Home Dog Training — Montreal": "Entraînement canin à domicile — Montréal",
  "Stop planning your life around your dog's triggers. Structured protocols for lunging, barking, fear, and shutting down — in both private and group settings.":
  ...
  "The first few months shape the next ten years. Build confidence, manners, and a strong bond from the very beginning.":
    "Les premiers mois façonnent les dix prochaines années. Développez la confiance, les bonnes manières et un lien solide dès le départ.",
  "Training where it matters most — in your home, in your neighbourhood, on your schedule. Every program starts with a personalised consultation.":
    "L'entraînement là où il compte le plus : chez vous, dans votre quartier, selon votre horaire. Chaque programme commence par une consultation personnalisée.",
  ...
  "Meet with a trainer, clarify your goals and expectations, and let us create a personalized program designed to help you achieve the results you need.":
    "Rencontrez un entraîneur, clarifiez vos objectifs et vos attentes, et laissez-nous créer un programme personnalisé conçu pour vous aider à obtenir les résultats dont vous avez besoin.",
  ...
  "You're a first-time dog owner and don't know where to start.":
    "Vous êtes un nouveau propriétaire de chien et vous ne savez pas par où commencer.",
  ...
  "Your dog lunges, barks, or shuts down on walks.": "Votre chien se lance, jappe ou fige en promenade.",
  "You feel embarrassed, frustrated, or helpless on leash.":
    "Vous vous sentez gêné, frustré ou impuissant en laisse.",
  "Other trainers told you your dog is 'too much.'": "D'autres entraîneurs vous ont dit que votre chien était « trop intense ».",
  "The Three D's — Duration, Distance, Distraction": "Les trois D — durée, distance, distraction",
  "Three attention cues — Name, Touch, Leash": "Trois signaux d'attention — nom, toucher, laisse",
  "Active and static engagement": "Engagement actif et statique",
  "Leash work and reward placement": "Travail en laisse et placement des récompenses",
  ...
  "You want a trainer's full attention on your specific situation.":
    "Vous voulez toute l'attention d'un entraîneur sur votre situation précise.",
  "You've tried group classes and your dog needs something more tailored.":
    "Vous avez essayé les cours de groupe et votre chien a besoin de quelque chose de plus personnalisé.",
  "You're dealing with reactivity, anxiety, aggression, or guarding.":
    "Vous gérez de la réactivité, de l'anxiété, de l'agressivité ou de la protection des ressources.",
  "You want a clear plan built around your dog — not a generic curriculum.":
    "Vous voulez un plan clair construit autour de votre chien, pas un curriculum générique.",
  "Behaviour modification": "Modification du comportement",
  "Leash reactivity": "Réactivité en laisse",
  "Aggression management": "Gestion de l'agressivité",
  "Confidence building": "Développement de la confiance",
  "Handler skill development": "Développement des compétences du maître",
  "Separation anxiety protocol": "Protocole d'anxiété de séparation",
  ...
  "You want a well-mannered dog you can take anywhere in Montreal.":
    "Vous voulez un chien bien élevé que vous pouvez emmener partout à Montréal.",
  "You're ready to move beyond basics and build real-world reliability.":
    "Vous êtes prêt à dépasser les bases et à bâtir une fiabilité dans la vraie vie.",
  "Your dog pulls on leash, ignores recall, or has zero impulse control outside.":
    "Votre chien tire en laisse, ignore le rappel ou n'a aucun contrôle des impulsions dehors.",
  "You want your dog to walk calmly past distractions, dogs, and people.":
    "Vous voulez que votre chien passe calmement devant les distractions, les chiens et les gens.",
  "Engagement and relationship building": "Engagement et développement de la relation",
  "Reliable recall in real environments": "Rappel fiable dans de vrais environnements",
  "Impulse control and focus under pressure": "Contrôle des impulsions et concentration sous pression",
  "Pack walks and new environments": "Marches en groupe et nouveaux environnements",
  ...
  "You're not sure how to socialise safely without overwhelming them.":
    "Vous ne savez pas comment le socialiser en sécurité sans le submerger.",
  "Your teen pup is hitting the 'selective hearing' phase.":
    "Votre jeune chien entre dans la phase de « surdité sélective ».",
  "You want to build good habits before bad ones take root.":
    "Vous voulez bâtir de bonnes habitudes avant que les mauvaises s'installent.",
  "You want a confident, well-adjusted dog — not just a trained one.":
    "Vous voulez un chien confiant et équilibré, pas seulement entraîné.",
  "Confidence building through guided play": "Développement de la confiance par le jeu guidé",
  "Controlled socialisation with other puppies": "Socialisation contrôlée avec d'autres chiots",
  "Engagement, focus, and relationship development": "Engagement, concentration et développement de la relation",
  "Obstacle courses and novel experiences": "Parcours d'obstacles et nouvelles expériences",
  "Introduction to the six basic commands": "Introduction aux six commandes de base",
  "Marker training and distraction exposure": "Marqueur et exposition aux distractions",
  ...
  "You want training in the exact environment where behaviour breaks down.":
    "Vous voulez travailler exactement dans l'environnement où le comportement se dégrade.",
  "Your schedule makes it hard to attend classes at a fixed location.":
    "Votre horaire rend difficile la participation à des cours à lieu fixe.",
  "You prefer one-on-one attention from an expert in your own space.":
    "Vous préférez l'attention individuelle d'un expert dans votre propre espace.",
  "You've tried facility-based training and the skills didn't transfer home.":
    "Vous avez essayé l'entraînement en centre et les compétences ne se sont pas transférées à la maison.",
  "In-home consultation and assessment": "Consultation et évaluation à domicile",
  "Customised behaviour modification plan": "Plan personnalisé de modification du comportement",
  "Door manners and guest greeting": "Bonnes manières à la porte et accueil des invités",
  "House training and structure": "Propreté et structure à la maison",
  "Leash skills in your neighbourhood": "Compétences en laisse dans votre quartier",
  ...
  "Level 1 Obedience Class": "Cours d'obéissance niveau 1",
  "Level 1 Obedience": "Obéissance niveau 1",
  "Basic Obedience": "Obéissance de base",
  "Group setting focused on the 6 basic commands while emphasizing engagement, obedience, and neutral behavior around distractions.":
    "Cadre de groupe axé sur les 6 commandes de base en mettant l'accent sur l'engagement, l'obéissance et un comportement neutre autour des distractions.",
  "As of 9 months old": "À partir de 9 mois",
  "Sit, down, stay, heel, come and place": "Assis, couché, reste, au pied, viens et place",
  "Neutrality and impulse control around distractions":
    "Neutralité et contrôle des impulsions autour des distractions",
  "Package: 4 classes · $360 + tax": "Forfait : 4 cours · 360 $ + taxes",
  "Six basic commands: sit, down, stay, heel, come, and place — with engagement and neutral behavior around distractions":
    "Six commandes de base : assis, couché, reste, au pied, viens et place — avec engagement et comportement neutre autour des distractions",
  "4-class series · basic obedience": "Série de 4 cours · obéissance de base",
  "Level 2 Obedience Class": "Cours d'obéissance niveau 2",
  "Level 2 Obedience": "Obéissance niveau 2",
  "Pack Walk Structure": "Structure de marche en meute",
  "Join the pack! Group walks across Montreal designed to build confidence, improve obedience, and practice real-world training.":
    "Rejoignez la meute! Marches en groupe à Montréal pour renforcer la confiance, améliorer l'obéissance et pratiquer l'entraînement en conditions réelles.",
  "As of 12 months": "À partir de 12 mois",
  "Real-world training and proofing": "Entraînement et généralisation en conditions réelles",
  "$25/class for the lifetime of the dog after package completion!":
    "25 $/cours pour la vie du chien après la fin du forfait!",
  "for 5 classes": "pour 5 cours",
  "5-class series · pack walks": "Série de 5 cours · marches en meute",
  "Group walks across Montreal — real-world training and proofing":
    "Marches en groupe à Montréal — entraînement et généralisation en conditions réelles",
  "After graduation, rejoin this class for the lifetime of your dog for $25 per class":
    "Après la graduation, rejoignez ce cours pour la vie de votre chien à 25 $ par cours",
  "Level 3 Obedience Class": "Cours d'obéissance niveau 3",
  "Level 3 Obedience": "Obéissance niveau 3",
  "Advanced Obedience": "Obéissance avancée",
  "Taking training to the next Level!": "Passez l'entraînement au niveau supérieur!",
  "Off-Leash Reliability": "Fiabilité sans laisse",
  "Package: 5 classes · $450 + tax · Coming soon": "Forfait : 5 cours · 450 $ + taxes · Bientôt disponible",
  "Off-leash reliability — basic commands and engagement performed off-leash":
    "Fiabilité sans laisse — commandes de base et engagement sans laisse",
  Puppies: "Chiots",
  "Teen puppies": "Chiots adolescents",
  "For dogs who struggle around triggers": "Pour les chiens qui ont de la difficulté avec les déclencheurs",
  "Foundation obedience": "Obéissance de base",
  "Intermediate obedience": "Obéissance intermédiaire",
  "Advanced obedience": "Obéissance avancée",
  ...
  "Fun and positive way for young puppies to start their training journey! Focused on proper play, confidence building, and creating successful interactions in a safe environment.":
    "Une façon amusante et positive pour les jeunes chiots de commencer leur parcours d'entraînement! Axé sur le jeu approprié, le renforcement de la confiance et des interactions réussies dans un environnement sécuritaire.",
  ...
  "Drop-in class": "Cours à la carte",
  "Must show proof of vaccination": "Preuve de vaccination obligatoire",
  "Cost per class: $50 + tax per class": "Coût par cours : 50 $ + taxes par cours",
  "Group class setting": "Cours en groupe",
  "10–20 weeks": "10 à 20 semaines",
  "$30 + tax per class": "30 $ + taxes par cours",
  "$50 + tax per class": "50 $ + taxes par cours",
  "per class · 10–20 weeks": "par cours · 10 à 20 semaines",
  "Group class · puppies 10–20 weeks": "Cours en groupe · chiots 10 à 20 semaines",
  "Drop-in · puppies 10–20 weeks": "À la carte · chiots 10 à 20 semaines",
  ...
  "Cost: $50 + tax per class": "Coût : 50 $ + taxes par cours",
  ...
  "Consultation required first": "Consultation requise au préalable",
  "5 months – 9 months": "5 à 9 mois",
  "for 4 classes": "pour 4 cours",
  "Age: 5 months to 9 months old": "Âge : 5 à 9 mois",
  "4-class series · dogs 5–9 months": "Série de 4 cours · chiens de 5 à 9 mois",
  "Package: 4 classes · $350 + tax": "Forfait : 4 cours · 350 $ + taxes",
  "Structured reactivity work with distance management and controlled reps.":
    "Travail structuré de réactivité avec gestion de la distance et répétitions contrôlées.",
  "Designed for reactive dogs that need gradual exposure to a group setting while working through distractions and overcoming reactivity.":
    "Conçu pour les chiens réactifs qui ont besoin d'une exposition graduelle à un cadre de groupe tout en travaillant les distractions et en surmontant la réactivité.",
  "Available for all ages": "Disponible pour tous les âges",
  "Focus: gradual exposure to a group setting while working through distractions and overcoming reactivity":
    "Focus : exposition graduelle à un cadre de groupe tout en travaillant les distractions et en surmontant la réactivité",
  "Dogs must have completed private classes or be approved during a consultation":
    "Les chiens doivent avoir complété des cours privés ou être approuvés lors d'une consultation",
  "Practical manners, reliable basics, and calm work around distractions.":
    "Bonnes manières pratiques, bases fiables et travail calme autour des distractions.",
  "The next step for dogs ready to build stronger obedience, duration, and distraction work.":
    "La prochaine étape pour les chiens prêts à renforcer l'obéissance, la durée et le travail autour des distractions.",
  "Advanced group obedience for teams ready for more challenging skills and proofing.":
    "Obéissance avancée en groupe pour les équipes prêtes à travailler des compétences plus difficiles.",
  "Confident socialization": "Socialisation confiante",
  "Body handling": "Manipulation corporelle",
  "Early manners": "Bonnes manières précoces",
  "Focus around distractions": "Concentration autour des distractions",
  "Leash and impulse control": "Laisse et contrôle des impulsions",
  "Handler coaching": "Coaching du maître",
  "Engage-Disengage pattern": "Patron engagement-désengagement",
  "Threshold distance work": "Travail de distance seuil",
  "Loose-leash walking": "Marche en laisse détendue",
  "Sit / down / stay / recall": "Assis / couché / reste / rappel",
  "Impulse control": "Contrôle des impulsions",
  "More reliability": "Plus de fiabilité",
  "Distance and duration": "Distance et durée",
  "Proofing around distractions": "Généralisation autour des distractions",
  "Advanced proofing": "Généralisation avancée",
  "Handler precision": "Précision du maître",
  "Higher-distraction reps": "Répétitions avec plus de distractions",
  Package: "Forfait",
  Unit: "Unité",
  "4 classes": "4 cours",
  "Coming soon": "Bientôt disponible",
  "See dates & availability": "Voir les dates et disponibilités",
  "Three steps to the right class": "Trois étapes vers le bon cours",
  "Complete an assessment": "Compléter une évaluation",
  "We meet you and your dog first so we can understand goals, behavior, and the right path.":
    "Nous vous rencontrons d'abord avec votre chien afin de comprendre les objectifs, le comportement et le bon parcours.",
  "Your trainer approves a program": "Votre entraîneur approuve un programme",
  ...
  "Dog's name": "Nom du chien",
  optional: "facultatif",
  "you@email.com": "vous@courriel.com",
  "e.g. Luna": "ex. Luna",
  ...
  "Book Assessment": "Réserver une évaluation",
  "Book or Reschedule Assessment": "Réserver ou déplacer une évaluation",
  "Try a different email": "Essayer un autre courriel",
  "Request received": "Demande reçue",
  "Welcome back": "Bon retour",
  "Classes for": "Cours pour",
  "Linked to": "Lié à",
  "Use a different email": "Utiliser un autre courriel",
  "your dog": "votre chien",
  "Request a group class": "Demander un cours de groupe",
  "Loading classes…": "Chargement des cours…",
  "Choose a class type": "Choisissez un type de cours",
  "No upcoming series": "Aucune série à venir",
  "upcoming series": "séries à venir",
  "All programs": "Tous les programmes",
  "Please read and accept the group class agreement before requesting a spot.":
    "Veuillez lire et accepter l'entente de cours de groupe avant de demander une place.",
  "sessions included": "séances incluses",
  "spots remaining": "places restantes",
  "left": "restantes",
  "Sending request...": "Envoi de la demande...",
  Full: "Complet",
  "Request full series": "Demander la série complète",
  "Pending requests": "Demandes en attente",
  "Status: waiting for staff review": "Statut : en attente de révision par l'équipe",
  "Upcoming group sessions": "Séances de groupe à venir",
  "No upcoming group sessions on file.": "Aucune séance de groupe à venir au dossier.",
  "Staff is reviewing": "L'équipe révise",
  ...
  "3. Information Sharing": "3. Partage des renseignements",
  "4. Payment Processing": "4. Traitement des paiements",
  "5. Cookies & Analytics": "5. Témoins et analyses",
  ...
  "When you book a consultation, sign up for a program, or contact us, we may collect your name, email address, phone number, mailing address, and information about your dog (breed, age, behavioral concerns). We also collect standard analytics data such as IP address, browser type, and pages visited.":
    "Lorsque vous réservez une consultation, vous inscrivez à un programme ou nous contactez, nous pouvons recueillir votre nom, adresse courriel, numéro de téléphone, adresse postale et des renseignements sur votre chien (race, âge, préoccupations comportementales). Nous recueillons aussi des données d'analyse standard comme l'adresse IP, le type de navigateur et les pages visitées.",
  "We use your information to provide and improve our training services, communicate with you about bookings and programs, process payments, send occasional updates or tips (only with your consent), and analyze site usage to improve our website experience.":
    "Nous utilisons vos renseignements pour fournir et améliorer nos services, communiquer avec vous au sujet des réservations et programmes, traiter les paiements, envoyer des mises à jour ou conseils occasionnels (avec votre consentement) et analyser l'utilisation du site afin d'améliorer l'expérience.",
  "We do not sell, rent, or trade your personal information. We may share data with trusted third-party service providers (payment processors, email platforms, analytics tools) solely to operate our business. These providers are contractually obligated to protect your information.":
    "Nous ne vendons, louons ni échangeons vos renseignements personnels. Nous pouvons partager des données avec des fournisseurs de services tiers de confiance (processeurs de paiement, plateformes courriel, outils d'analyse) uniquement pour exploiter notre entreprise. Ces fournisseurs sont tenus par contrat de protéger vos renseignements.",
  "Payments are processed securely through Stripe. We do not store your credit card information on our servers. All transactions are encrypted and handled in accordance with PCI-DSS standards.":
    "Les paiements sont traités de manière sécurisée par Stripe. Nous ne stockons pas les renseignements de carte de crédit sur nos serveurs. Toutes les transactions sont chiffrées et traitées conformément aux normes PCI-DSS.",
  "We use cookies and similar technologies to analyze traffic and improve your browsing experience. You can disable cookies in your browser settings, though some features of the site may not function as intended.":
    "Nous utilisons des témoins et technologies similaires pour analyser le trafic et améliorer votre expérience de navigation. Vous pouvez désactiver les témoins dans les paramètres de votre navigateur, mais certaines fonctionnalités pourraient ne pas fonctionner comme prévu.",
  "We retain your personal information for as long as necessary to provide our services and comply with legal obligations. You may request deletion of your data at any time by contacting us.":
    "Nous conservons vos renseignements personnels aussi longtemps que nécessaire pour fournir nos services et respecter nos obligations légales. Vous pouvez demander la suppression de vos données en nous contactant.",
  "Under applicable Canadian and Quebec privacy laws, you have the right to access, correct, or delete your personal information. To exercise these rights, contact us at":
    "En vertu des lois canadiennes et québécoises applicables en matière de protection des renseignements personnels, vous avez le droit d'accéder à vos renseignements, de les corriger ou de les supprimer. Pour exercer ces droits, contactez-nous à",
  "We may update this policy from time to time. Changes will be posted on this page with an updated revision date.":
    "Nous pouvons mettre cette politique à jour de temps à autre. Les changements seront publiés sur cette page avec une date de révision mise à jour.",
  "1. Agreement to Terms": "1. Acceptation des conditions",
  "2. Services": "2. Services",
  "3. Bookings & Payments": "3. Réservations et paiements",
  "4. Cancellation & Rescheduling": "4. Annulation et déplacement",
  "5. Client Responsibilities": "5. Responsabilités du client",
  "6. Assumption of Risk": "6. Acceptation des risques",
  "7. No Guarantee of Results": "7. Aucune garantie de résultats",
  "8. Intellectual Property": "8. Propriété intellectuelle",
  "9. Photos & Testimonials": "9. Photos et témoignages",
  "10. Limitation of Liability": "10. Limitation de responsabilité",
  "11. Governing Law": "11. Droit applicable",
  "12. Changes to These Terms": "12. Modifications des conditions",
  "13. Contact Us": "13. Nous contacter",
  "By accessing or using the Montreal Canine Training website and services, you agree to be bound by these Terms of Service. If you do not agree, please do not use our website or services.":
    "En accédant au site Web et aux services d'Entraînement Canin Montréal ou en les utilisant, vous acceptez d'être lié par ces conditions d'utilisation. Si vous n'acceptez pas, veuillez ne pas utiliser notre site ou nos services.",
  "Montreal Canine Training Inc. provides dog training programs, consultations, and related services in the Montreal area. All services are subject to availability and our professional assessment of suitability for your dog.":
    "Entraînement Canin Montréal inc. offre des programmes d'entraînement canin, des consultations et des services connexes dans la région de Montréal. Tous les services sont assujettis aux disponibilités et à notre évaluation professionnelle de la pertinence pour votre chien.",
  "Bookings are confirmed upon receipt of payment. All prices are listed in Canadian dollars (CAD) and are subject to applicable taxes. Payment is processed securely through Stripe.":
    "Les réservations sont confirmées à la réception du paiement. Tous les prix sont en dollars canadiens (CAD) et assujettis aux taxes applicables. Le paiement est traité de manière sécurisée par Stripe.",
  "We require at least 24 hours notice for cancellations or rescheduling. Late cancellations (less than 24 hours) may incur a fee. No-shows are charged in full. Refunds for unused sessions in a package are issued at our discretion and may be subject to a prorated adjustment.":
    "Nous exigeons un préavis d'au moins 24 heures pour les annulations ou déplacements. Les annulations tardives (moins de 24 heures) peuvent entraîner des frais. Les absences sont facturées en totalité. Les remboursements de séances inutilisées dans un forfait sont accordés à notre discrétion et peuvent être ajustés au prorata.",
  "You agree to provide accurate information about your dog's health, behavior history, and vaccination status. You are responsible for following the training plan and homework provided between sessions. You must inform us of any known bite history or aggressive behavior prior to the first session.":
    "Vous acceptez de fournir des renseignements exacts sur la santé de votre chien, son historique comportemental et son statut vaccinal. Vous êtes responsable de suivre le plan d'entraînement et les devoirs entre les séances. Vous devez nous informer de tout historique de morsure ou comportement agressif connu avant la première séance.",
  "Dog training involves inherent risks including, but not limited to, scratches, bites, and other injuries. By participating in our programs, you acknowledge and accept these risks. Montreal Canine Training Inc. is not liable for injuries to persons or animals that occur during or as a result of training, except where caused by our gross negligence.":
    "L'entraînement canin comporte des risques inhérents, notamment des griffures, morsures et autres blessures. En participant à nos programmes, vous reconnaissez et acceptez ces risques. Entraînement Canin Montréal inc. n'est pas responsable des blessures aux personnes ou aux animaux survenant pendant ou à la suite de l'entraînement, sauf en cas de négligence grave de notre part.",
  "While we are committed to providing professional, evidence-based training, we cannot guarantee specific outcomes. Results depend on many factors including the dog's temperament, history, and the owner's consistency in applying training techniques. We will always provide an honest assessment of what is achievable.":
    "Même si nous nous engageons à offrir un entraînement professionnel fondé sur les données, nous ne pouvons garantir des résultats précis. Les résultats dépendent de nombreux facteurs, dont le tempérament du chien, son historique et la constance du propriétaire dans l'application des techniques. Nous fournirons toujours une évaluation honnête de ce qui est réalisable.",
  "All content on this website — including text, images, videos, logos, and training materials — is the property of Montreal Canine Training Inc. and is protected by Canadian copyright law. You may not reproduce, distribute, or use our content without written permission.":
    "Tout le contenu de ce site Web, y compris les textes, images, vidéos, logos et matériel d'entraînement, appartient à Entraînement Canin Montréal inc. et est protégé par la loi canadienne sur le droit d'auteur. Vous ne pouvez pas reproduire, distribuer ou utiliser notre contenu sans autorisation écrite.",
  "We may take photos or videos during training sessions for use on our website, social media, or marketing materials. If you do not wish to be photographed, please let us know before your session. Testimonials are shared with the client's consent.":
    "Nous pouvons prendre des photos ou vidéos pendant les séances pour les utiliser sur notre site Web, nos réseaux sociaux ou nos documents marketing. Si vous ne souhaitez pas être photographié, veuillez nous en informer avant votre séance. Les témoignages sont partagés avec le consentement du client.",
  "To the maximum extent permitted by law, Montreal Canine Training Inc. shall not be liable for any indirect, incidental, or consequential damages arising from the use of our services or website.":
    "Dans toute la mesure permise par la loi, Entraînement Canin Montréal inc. ne peut être tenue responsable des dommages indirects, accessoires ou consécutifs découlant de l'utilisation de nos services ou de notre site Web.",
  "These terms are governed by and construed in accordance with the laws of the Province of Quebec and the federal laws of Canada applicable therein.":
    "Ces conditions sont régies et interprétées conformément aux lois de la province de Québec et aux lois fédérales du Canada qui s'y appliquent.",
  "We reserve the right to update these terms at any time. Changes take effect when posted on this page. Continued use of our services constitutes acceptance of the updated terms.":
    "Nous nous réservons le droit de mettre ces conditions à jour en tout temps. Les changements entrent en vigueur lorsqu'ils sont publiés sur cette page. L'utilisation continue de nos services constitue l'acceptation des conditions mises à jour.",
  "Training That Protects the Bond": "Un entraînement qui protège le lien",
  "Who we are, what we believe, and why we train the way we do.":
    "Qui nous sommes, ce en quoi nous croyons et pourquoi nous entraînons de cette façon.",
  ...
  "High-drive dogs, serious rehabilitation, advanced obedience, reactivity":
    "Chiens à fort instinct de travail, réadaptation sérieuse, obéissance avancée, réactivité",
  ...
  "Makes high-distraction urban walks feel manageable — and even enjoyable.":
    "Rend les promenades urbaines très stimulantes gérables, et même agréables.",
  "He has two dogs of his own and lives by the philosophy that structure creates freedom.":
    "Il a deux chiens et vit selon la philosophie que la structure crée la liberté.",
  "Animals have always been central to Jessica's life. She owns two dogs — Bones the husky and Fish the chihuahua — both raised from puppyhood. After eight years in dog grooming, she pursued training full-time, completing the MTL Canine Training Program with over 80 hours of hands-on experience.":
    "Les animaux ont toujours été au centre de la vie de Jessica. Elle a deux chiens, Bones le husky et Fish le chihuahua, tous deux élevés depuis chiots. Après huit ans en toilettage canin, elle s'est consacrée à l'entraînement à temps plein et a complété le programme MTL Canine Training avec plus de 80 heures d'expérience pratique.",
  "Helps fearful dogs find their confidence without force or flooding.":
    "Aide les chiens craintifs à retrouver confiance sans force ni immersion excessive.",
  "She specializes in confidence-building, reactivity, and obedience training.":
    "Elle se spécialise dans le développement de la confiance, la réactivité et l'obéissance.",
  "Our Philosophy": "Notre philosophie",
  "At Montreal Canine Training, we help build strong, healthy relationships between dogs and their owners. With a proven track record, we consistently deliver real, professional, and effective training solutions.":
    "Chez Entraînement Canin Montréal, nous aidons à bâtir des relations fortes et saines entre les chiens et leurs propriétaires. Avec des résultats éprouvés, nous offrons des solutions d'entraînement réelles, professionnelles et efficaces.",
  "Every dog is assessed individually to create a personalized training plan. From basic/advanced obedience to severe behavioral issues, our experienced team delivers real results. We believe training is about the human, not the dog. Your dog is already doing what makes sense to them. We help you understand why and give you the tools to guide them without breaking trust. We train in the real world, not just at our facility — progressing into everyday environments like parks, cafés, hardware stores and markets.":
    "Chaque chien est évalué individuellement afin de créer un plan personnalisé. De l'obéissance de base ou avancée aux problèmes comportementaux sévères, notre équipe expérimentée obtient de vrais résultats. Nous croyons que l'entraînement concerne l'humain autant que le chien. Votre chien fait déjà ce qui a du sens pour lui. Nous vous aidons à comprendre pourquoi et vous donnons les outils pour le guider sans briser la confiance. Nous entraînons dans la vraie vie, pas seulement dans nos installations, en progressant vers des environnements quotidiens comme les parcs, cafés, quincailleries et marchés.",
  "We don't just hand you techniques. We give you a plan, ongoing support between sessions, and stay in your corner until you see results — because training isn't a one-off, it's a partnership.":
    "Nous ne vous remettons pas simplement des techniques. Nous vous donnons un plan, du soutien entre les séances et restons dans votre coin jusqu'à ce que vous voyiez des résultats, parce que l'entraînement n'est pas un événement ponctuel, c'est un partenariat.",
  "Our Methods": "Nos méthodes",
  "Positive reinforcement training, motivation and reward based training":
    "Entraînement par renforcement positif, motivation et récompenses",
  "Our approach:": "Notre approche :",
  "We build and shape behaviours using positive reinforcement, clear communication, and motivation, creating confident, engaged dogs. We don't use fear or pain. We adapt our approach to their needs, perception and understanding. Our expertise in a variety of proven training methods allows us to support a wider range of dogs, resulting in high success rates, from early puppy development to severe behavioral problems.":
    "Nous construisons et façonnons les comportements avec le renforcement positif, une communication claire et la motivation, afin de créer des chiens confiants et engagés. Nous n'utilisons ni peur ni douleur. Nous adaptons notre approche à leurs besoins, leur perception et leur compréhension. Notre expertise dans plusieurs méthodes éprouvées nous permet d'aider un large éventail de chiens, du développement précoce du chiot aux problèmes comportementaux sévères.",
  "What to expect in a session:": "À quoi s'attendre pendant une séance :",
  "We meet you and your dog where you are — literally and figuratively. Sessions happen in real environments: your neighborhood, a park, your home. We observe, we teach, we practice. You leave with homework, and we support you between sessions with check-ins and guidance.":
    "Nous vous rencontrons, vous et votre chien, là où vous en êtes, littéralement et figurativement. Les séances se déroulent dans de vrais environnements : votre quartier, un parc, votre maison. Nous observons, enseignons et pratiquons. Vous repartez avec des exercices, et nous vous soutenons entre les séances avec des suivis et des conseils.",
  "Your dog's emotional wellbeing:": "Le bien-être émotionnel de votre chien :",
  "We believe a dog who feels safe learns faster and bonds deeper. We never push a dog past their threshold. We work at their pace, and we prioritize their emotional state in every decision we make.":
    "Nous croyons qu'un chien qui se sent en sécurité apprend plus vite et crée un lien plus profond. Nous ne poussons jamais un chien au-delà de son seuil. Nous avançons à son rythme et priorisons son état émotionnel dans chaque décision.",
  ...
  "Tips, stories, and science-backed guidance from our team.":
    "Conseils, histoires et orientation fondée sur la science de la part de notre équipe.",
  All: "Tous",
  "Puppy Tips": "Conseils chiots",
  "Reactivity & Anxiety": "Réactivité et anxiété",
  "City Living with Dogs": "Vie urbaine avec un chien",
  "Training Myths": "Mythes d'entraînement",
  "Client Stories": "Histoires clients",
  Image: "Image",
  "Read more": "Lire la suite",
  "Why Your Dog Pulls on the Leash (And What Actually Fixes It)":
    "Pourquoi votre chien tire en laisse (et ce qui corrige vraiment le problème)",
  "The science behind leash pulling and the methods that work in real-world Montreal.":
    "La science derrière la traction en laisse et les méthodes qui fonctionnent dans la vraie vie à Montréal.",
  "The Real Reason Your Dog Is Reactive — It's Not What You Think":
    "La vraie raison pour laquelle votre chien est réactif — ce n'est pas ce que vous pensez",
  "Understanding the root causes of reactivity can change how you approach training.":
    "Comprendre les causes profondes de la réactivité peut transformer votre façon d'aborder l'entraînement.",
  "99% of Dogs Have Behavioral Issues. Here's Why That's Good News.":
    "99 % des chiens ont des problèmes comportementaux. Voici pourquoi c'est une bonne nouvelle.",
  "Most dogs struggle with something. That doesn't mean yours is broken — it means help exists.":
    "La plupart des chiens ont de la difficulté avec quelque chose. Cela ne veut pas dire que le vôtre est brisé, mais qu'il existe de l'aide.",
  "What Happens in a Dog Training Evaluation (And Why It Matters)":
    "Ce qui se passe lors d'une évaluation canine (et pourquoi c'est important)",
  "A behind-the-scenes look at how we assess your dog and build a custom plan.":
    "Un aperçu de la façon dont nous évaluons votre chien et construisons un plan personnalisé.",
  "Apartment Living with a Dog in Montreal: A Survival Guide":
    "Vivre en appartement avec un chien à Montréal : guide de survie",
  "Tips for keeping your dog happy and well-behaved in tight urban spaces.":
    "Conseils pour garder votre chien heureux et bien élevé dans les petits espaces urbains.",
  "How to Socialize Your Puppy Without Overwhelming Them":
    "Comment socialiser votre chiot sans le submerger",
  "The right balance of exposure and protection for your puppy's critical development period.":
    "Le bon équilibre entre exposition et protection pendant la période critique de développement de votre chiot.",
  "Why We Train in Parks, Not Classrooms": "Pourquoi nous entraînons dans les parcs, pas dans les salles de classe",
  "Real-world training means real-world results. Here's why location matters.":
    "L'entraînement dans la vraie vie donne des résultats dans la vraie vie. Voici pourquoi le lieu compte.",
  "Separation Anxiety: The Signs, The Myths, and What Actually Helps":
    "Anxiété de séparation : les signes, les mythes et ce qui aide vraiment",
  "Cutting through the noise to give you a clear path forward.":
    "On fait le tri pour vous donner un chemin clair.",
  "How to Choose a Dog Trainer in Montreal (Red Flags and Green Flags)":
    "Comment choisir un entraîneur canin à Montréal (signaux d'alerte et bons signes)",
  "What to look for — and what to run from — when hiring a trainer.":
    "Ce qu'il faut rechercher, et ce qu'il faut éviter, lorsque vous engagez un entraîneur.",
  "Your Dog Doesn't Need to Be 'Fixed' — They Need a Plan":
    "Votre chien n'a pas besoin d'être « réparé » — il a besoin d'un plan",
  "One owner's journey from frustration to a calmer, happier dog.":
    "Le parcours d'un propriétaire, de la frustration à un chien plus calme et plus heureux.",
  "Real Dogs. Real Results.": "De vrais chiens. De vrais résultats.",
  ...
  "Your program signup is confirmed. Our team will contact you with next steps.":
    "Votre inscription au programme est confirmée. Notre équipe vous contactera avec les prochaines étapes.",
  "Your in-person evaluation is confirmed. Our team will contact you shortly to schedule your session.":
  ...
  "Typical topics covered in private classes:": "Sujets typiques couverts en cours privés :",
  "Leash Reactivity": "Réactivité en laisse",
  "Aggression, Resource guarding, Separation anxiety":
    "Agressivité, protection des ressources, anxiété de séparation",
  "Specialized training upon client request": "Entraînement spécialisé sur demande du client",
  "Private dog training session in Montreal": "Séance de dressage privé à Montréal",
  "Dog training consultation in a Montreal park": "Consultation de dressage canine dans un parc montréalais",
