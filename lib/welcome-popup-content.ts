...
export const welcomePopupContent: Record<AppLocale, WelcomePopupCopy> = {
  en: {
    ...
    backCta: "Back",
    photoAlt: "A pug puppy training with two handlers in a Montreal park",
  ...
  fr: {
    ...
    backCta: "Retour",
    photoAlt: "Un chiot carlin en entraînement avec deux personnes dans un parc de Montréal",
