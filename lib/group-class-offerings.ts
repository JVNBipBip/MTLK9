...
export const GROUP_CLASS_OFFERINGS: GroupClassOffering[] = [
  {
    ...
    forText: "Puppies",
    summary: "Group socialization for puppies 10–20 weeks — play, handling, and confidence in a trainer-led class.",
    bullets: ["Group class setting", "10–20 weeks", "$30 + tax per class"],
    image: "/images/Classes images/puppy_social.jpg",
    packagePrice: "$30 + tax",
    packageDetail: "per class · 10–20 weeks",
    heroEyebrow: "Group class · puppies 10–20 weeks",
    ...
    classInfo: [
      ...
      "Every puppy must complete an evaluation session before joining this class.",
    ],
    goals: [
  ...
  },
  {
    ...
    bullets: ["Group class setting", "4–8 months", "$320 + tax · 4 classes"],
    image: "/images/Classes images/teen_puppy.webp",
    imageAvif: "/images/Classes images/teen_puppy.avif",
    packagePrice: "$320 + tax",
    unitPrice: "$90 + tax",
    packageDetail: "4 classes",
    heroEyebrow: "4-class series · adolescent dogs",
    ...
    classInfo: [
      "Group class setting",
      "Age: 4 months to 8 months old",
      "Package: 4 classes · $320 + tax",
  ...
  },
  {
    ...
    classInfo: [
      ...
      "Focus: slowly introducing dogs to a group setting — not basic commands",
      "Dogs must have completed private classes or be approved during an evaluation",
  ...
  },
  {
    ...
    unitPrice: "$95 + tax",
    packageDetail: "4 classes",
    heroEyebrow: "4-class series · foundation obedience",
    ...
    classInfo: [
      "Group class setting",
      "Package: 4 classes · $350 + tax",
      "Intro to obedience training, engagement work, and relationship building",
      "Complete all classes within 2 months of your start date",
      "Minimum 3 dogs required for the class to run · classes hosted biweekly",
      "Payment due in full before the first session",
      "Bring food/treats, leash, collar, water, toy, and potty bags to every session",
  ...
  },
  {
    ...
    heroEyebrow: "5-class series · intermediate obedience",
    ...
    overviewTitle: "What to expect",
    classInfo: [
      "Group class setting · pack walk structure",
      "Package: 5 classes · $450 + tax",
      "Classes at popular public parks in Montreal with high distractions and realistic scenarios",
      "After graduation, rejoin this class for the lifetime of your dog for $20 entry",
      "Complete all classes within 2 months of your start date",
  ...
  },
  {
    ...
    overviewTitle: "What to expect",
    classInfo: [
      "Group class setting · off-leash work",
      "Package: 5 classes · $400 + tax",
      "Basic commands and engagement performed off-leash",
