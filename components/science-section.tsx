      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <ScrollAnimatedText
            ...
            className="font-display text-3xl md:text-4xl text-primary-foreground text-balance mb-6 lg:text-7xl font-semibold tracking-tight"
          />
        ...
        <div className="reveal opacity-0 animation-delay-400 grid grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center">
              ...
              <div className="font-display text-4xl md:text-5xl font-bold tracking-tight text-primary-foreground mb-2">
          ...
          {principles.map((principle, index) => (
            ...
            >
              <div className="border-t border-primary-foreground/20 pt-8">
                ...
                <h3 className="font-display text-xl md:text-2xl font-semibold tracking-tight text-primary-foreground mb-4">
                  {principle.title}
                </h3>
