      ...
      <div className="w-full">
        <div className="text-center mb-16 lg:mb-20 px-6">
          ...
          <ScrollAnimatedText
            ...
            className="font-display text-3xl md:text-4xl text-foreground text-balance lg:text-7xl font-semibold tracking-tight"
          />
        </div>
        ...
        <div className="reveal opacity-0 animation-delay-400">
          <div ref={scrollRef} className="flex gap-6 overflow-x-hidden" style={{ scrollBehavior: "auto" }}>
            {duplicatedTestimonials.map((testimonial, index) => (
              ...
              >
                <blockquote className="font-sans text-base md:text-lg text-foreground leading-relaxed mb-6">
                  "{testimonial.quote}"
                </blockquote>
