      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <ScrollAnimatedText
            ...
            className="font-display text-3xl text-foreground text-balance mb-6 md:text-7xl font-semibold tracking-tight"
          />
            ...
            >
              <div className="bg-card rounded-3xl overflow-hidden border border-border/50 shadow-lg shadow-primary/5 hover:shadow-xl hover:shadow-primary/10 transition-all duration-500">
                ...
                <div className="p-6 lg:p-8">
                  <h3 className="font-display text-foreground mb-3 text-3xl font-semibold tracking-tight">{product.name}</h3>
